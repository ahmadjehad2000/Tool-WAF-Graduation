...
class Hosts extends Component {
    ...
    initiateExtendedPortScan(hostname) {
        ...
        let requestUrl = process.env.REACT_APP_WAF_HOST + '/scan?target=' + hostname
    ...
    fetchExtendedPortScanResults(hostname) {
        ...
        let requestUrl = process.env.REACT_APP_WAF_HOST + '/scan?target=' + hostname + '&token=' + this.state.token
